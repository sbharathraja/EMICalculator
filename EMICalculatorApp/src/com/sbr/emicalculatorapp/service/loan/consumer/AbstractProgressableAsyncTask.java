...
/**
 * Extending the android AsyncTask and provides operations to run a specific
 ...
 * 
 */
public abstract class AbstractProgressableAsyncTask<P, R> extends
		AsyncTask<P, Void, R> {
	...
	public final void setOnTaskCompletionListener(
			OnAsyncTaskCompleteListener<R> taskCompletionListener) {
	...
	/**
	 * Responsible for running the task in back ground thread while
	 * non-cancellable progress bar is showing.
	 * 
	 * @param parameter
	 *            -
	 * @return result of background thread.
	 * @throws Exception
	 */
